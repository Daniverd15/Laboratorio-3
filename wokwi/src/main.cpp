/*
 * main.cpp  -  UNAB-Ambiental  (Laboratorio 2)  -  version PlatformIO/VS Code
 * =====================================================================
 * MISMO codigo que wokwi/sketch.ino, adaptado a PlatformIO:
 *   - #include <Arduino.h>
 *   - prototipos de funciones (en .cpp no hay auto-prototipado como en .ino)
 *
 ...
 *
 * SEGURIDAD: rellena tus credenciales abajo SOLO para probar.
...
#define ID_SCOPE      "0ne00FDCA1E"            // ID Scope de tu app IoT Central
#define DEVICE_ID     "ve8okslkz9"         // Device ID registrado (real, Simular=No)
#define DEVICE_KEY    "PEGA_AQUI_LA_CLAVE_DEL_ESP32"  // Primary key del ESP32 (no subir la real)
// ---------------------------------------------------------------------
